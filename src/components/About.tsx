...
const About = () => {
  ...
  return <section id="about" className="py-24 bg-background scroll-mt-20">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">Every treatment at Elevated Health Augusta is overseen by board-certified providers with specialized training in ketamine therapy. We believe that exceptional mental health care requires both clinical precision and compassionate understanding of each patient's unique journey.</p>
            ...
            <div className="relative">
              <img src={clinicImage} alt="Warm, professional healthcare environment at Elevated Health Augusta" className="rounded-2xl shadow-lg w-full h-[500px] object-cover" />
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value, index) => <Card key={index} className="p-6 bg-muted/30 hover:bg-muted/50 transition-all duration-300 hover:-translate-y-1 border-border/50">
