...
const PricingComparison = () => {
  ...
  // Membership: $79 Wellness Assessment credit applied toward kit, then monthly membership
                ...
                <Card>
                  <CardContent className="p-6">
                    ...
                    <p className="text-sm text-muted-foreground">
                      ...
                      to membership for better value. Your $79 Wellness Assessment credit still applies to your 
