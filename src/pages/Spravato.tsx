  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        ...
        <meta 
          name="description" 
          content="SPRAVATO® esketamine nasal spray in Augusta, GA. $79 Wellness Assessment to verify insurance coverage. Chat with our Virtual Care Team 24/7. Often $0-50 copays with BCBS, TRICARE." 
        />
        <meta 
          name="keywords" 
        ...
        {/* Open Graph */}
        <meta property="og:title" content="SPRAVATO® Augusta | $79 Wellness Assessment to Verify Insurance | Elevated Health Augusta" />
        <meta property="og:description" content="SPRAVATO® esketamine nasal spray in Augusta, GA. $79 Wellness Assessment to verify insurance coverage. Chat with our Virtual Care Team 24/7." />
        ...
        <meta name="twitter:description" content="$79 Wellness Assessment to verify insurance coverage. Chat with our Virtual Care Team 24/7. BCBS, TRICARE accepted." />
