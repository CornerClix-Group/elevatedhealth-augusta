  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content="How ketamine works for depression, PTSD, and anxiety. $79 Wellness Assessment credited toward treatment. Chat with our Virtual Care Team 24/7. Evidence-based explainers backed by Yale research." 
        />
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="font-inter text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                Book a $79 Wellness Assessment to discuss your treatment options with our board-certified providers. The fee is credited toward your treatment.
              </p>
