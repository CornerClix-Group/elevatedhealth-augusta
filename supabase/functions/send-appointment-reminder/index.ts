  ...
  try {
    ...
    if (patient_phone && !send_to_all_tomorrow) {
      ...
      const message = custom_message || 
        ...
        `If you need to reschedule, please call us at (706) 710-2704. We look forward to seeing you!`;
    ...
    // Mode 2: Send batch reminders to all patients with phone numbers (manual trigger)
      ...
      for (const patient of patients || []) {
        ...
        const message = 
          ...
          `Please arrive 10 minutes early. If you need to reschedule, call (706) 710-2704. See you soon!`;
